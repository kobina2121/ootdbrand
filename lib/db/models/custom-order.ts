...
const customOrderSchema = new Schema(
  {
    ...
    transactionFeeSnapshot: { type: Number, required: true, min: 0, default: 0 },
    ...
    bustSize: { type: String, required: false, trim: true },
    waistSize: { type: String, required: false, trim: true },
    hipSize: { type: String, required: false, trim: true },
