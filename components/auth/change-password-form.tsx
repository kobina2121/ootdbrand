...
export function ChangePasswordForm({ cardClassName }: ChangePasswordFormProps) {
 ...
 return (
 <Card
 className={`mx-auto w-full max-w-md rounded-3xl border-black/10 bg-white/90 shadow-sm ${cardClassName ?? ""}`}
 >
 ...
 <PasswordInput name="currentPassword" placeholder="Current password" className="h-11 rounded-xl border-black/15 " required />
 <PasswordInput
 name="newPassword"
